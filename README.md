...
| 0096 | [Unique Binary Search Trees](https://leetcode.com/problems/unique-binary-search-trees) | Medium | `Binary Search Tree` `Binary Tree` `Dynamic Programming` `Math` `Tree` |
...
| 0165 | [Compare Version Numbers](https://leetcode.com/problems/compare-version-numbers) | Medium | `String` `Two Pointers` |
| 0166 | [Fraction to Recurring Decimal](https://leetcode.com/problems/fraction-to-recurring-decimal) | Medium | `Hash Table` `Math` `String` |
...
| 0498 | [Diagonal Traverse](https://leetcode.com/problems/diagonal-traverse) | Medium | `Array` `Matrix` `Simulation` |
...
| 0515 | [Find Largest Value in Each Tree Row](https://leetcode.com/problems/find-largest-value-in-each-tree-row) | Medium | `Binary Tree` `Breadth-First Search` `Depth-First Search` `Tree` |
...
| 0535 | [Encode and Decode TinyURL](https://leetcode.com/problems/encode-and-decode-tinyurl) | Medium | `Design` `Hash Function` `Hash Table` `String` |
...
| 0570 | [Managers with at Least 5 Direct Reports](https://leetcode.com/problems/managers-with-at-least-5-direct-reports) | Medium | `Database` |
...
| 0807 | [Max Increase to Keep City Skyline](https://leetcode.com/problems/max-increase-to-keep-city-skyline) | Medium | `Array` `Greedy` `Matrix` |
...
| 0884 | [Uncommon Words from Two Sentences](https://leetcode.com/problems/uncommon-words-from-two-sentences) | Easy | `Counting` `Hash Table` `String` |
...
| 1005 | [Maximize Sum Of Array After K Negations](https://leetcode.com/problems/maximize-sum-of-array-after-k-negations) | Easy | `Array` `Greedy` `Sorting` |
...
| 1013 | [Partition Array Into Three Parts With Equal Sum](https://leetcode.com/problems/partition-array-into-three-parts-with-equal-sum) | Easy | `Array` `Greedy` |
...
| 1038 | [Binary Search Tree to Greater Sum Tree](https://leetcode.com/problems/binary-search-tree-to-greater-sum-tree) | Medium | `Binary Search Tree` `Binary Tree` `Depth-First Search` `Tree` |
...
| 1160 | [Find Words That Can Be Formed by Characters](https://leetcode.com/problems/find-words-that-can-be-formed-by-characters) | Easy | `Array` `Counting` `Hash Table` `String` |
...
| 1302 | [Deepest Leaves Sum](https://leetcode.com/problems/deepest-leaves-sum) | Medium | `Binary Tree` `Breadth-First Search` `Depth-First Search` `Tree` |
...
| 1332 | [Remove Palindromic Subsequences](https://leetcode.com/problems/remove-palindromic-subsequences) | Easy | `String` `Two Pointers` |
...
| 1370 | [Increasing Decreasing String](https://leetcode.com/problems/increasing-decreasing-string) | Easy | `Counting` `Hash Table` `String` |
| 1372 | [Longest ZigZag Path in a Binary Tree](https://leetcode.com/problems/longest-zigzag-path-in-a-binary-tree) | Medium | `Binary Tree` `Depth-First Search` `Dynamic Programming` `Tree` |
...
| 1466 | [Reorder Routes to Make All Paths Lead to the City Zero](https://leetcode.com/problems/reorder-routes-to-make-all-paths-lead-to-the-city-zero) | Medium | `Breadth-First Search` `Depth-First Search` `Graph Theory` |
...
| 1646 | [Get Maximum in Generated Array](https://leetcode.com/problems/get-maximum-in-generated-array) | Easy | `Array` `Simulation` |
...
| 1657 | [Determine if Two Strings Are Close](https://leetcode.com/problems/determine-if-two-strings-are-close) | Medium | `Counting` `Hash Table` `Sorting` `String` |
...
| 1736 | [Latest Time by Replacing Hidden Digits](https://leetcode.com/problems/latest-time-by-replacing-hidden-digits) | Easy | `Greedy` `String` |
...
| 1751 | [Maximum Number of Events That Can Be Attended II](https://leetcode.com/problems/maximum-number-of-events-that-can-be-attended-ii) | Hard | `Array` `Binary Search` `Dynamic Programming` `Sorting` |
...
| 1828 | [Queries on Number of Points Inside a Circle](https://leetcode.com/problems/queries-on-number-of-points-inside-a-circle) | Medium | `Array` `Geometry` `Math` |
...
| 1897 | [Redistribute Characters to Make All Strings Equal](https://leetcode.com/problems/redistribute-characters-to-make-all-strings-equal) | Easy | `Counting` `Hash Table` `String` |
...
| 1926 | [Nearest Exit from Entrance in Maze](https://leetcode.com/problems/nearest-exit-from-entrance-in-maze) | Medium | `Array` `Breadth-First Search` `Matrix` |
...
| 1945 | [Sum of Digits of String After Convert](https://leetcode.com/problems/sum-of-digits-of-string-after-convert) | Easy | `Simulation` `String` |
...
| 1961 | [Check If String Is a Prefix of Array](https://leetcode.com/problems/check-if-string-is-a-prefix-of-array) | Easy | `Array` `String` `Two Pointers` |
...
| 1995 | [Count Special Quadruplets](https://leetcode.com/problems/count-special-quadruplets) | Easy | `Array` `Enumeration` `Hash Table` |
...
| 2068 | [Check Whether Two Strings are Almost Equivalent](https://leetcode.com/problems/check-whether-two-strings-are-almost-equivalent) | Easy | `Counting` `Hash Table` `String` |
...
| 2103 | [Rings and Rods](https://leetcode.com/problems/rings-and-rods) | Easy | `Hash Table` `String` |
...
| 2115 | [Find All Possible Recipes from Given Supplies](https://leetcode.com/problems/find-all-possible-recipes-from-given-supplies) | Medium | `Array` `Graph Theory` `Hash Table` `String` `Topological Sort` |
| 2116 | [Check if a Parentheses String Can Be Valid](https://leetcode.com/problems/check-if-a-parentheses-string-can-be-valid) | Medium | `Greedy` `Stack` `String` |
...
| 2145 | [Count the Hidden Sequences](https://leetcode.com/problems/count-the-hidden-sequences) | Medium | `Array` `Prefix Sum` |
| 2148 | [Count Elements With Strictly Smaller and Greater Elements ](https://leetcode.com/problems/count-elements-with-strictly-smaller-and-greater-elements) | Easy | `Array` `Counting` `Sorting` |
...
| 2190 | [Most Frequent Number Following Key In an Array](https://leetcode.com/problems/most-frequent-number-following-key-in-an-array) | Easy | `Array` `Counting` `Hash Table` |
...
| 2200 | [Find All K-Distant Indices in an Array](https://leetcode.com/problems/find-all-k-distant-indices-in-an-array) | Easy | `Array` `Two Pointers` |
...
| 2221 | [Find Triangular Sum of an Array](https://leetcode.com/problems/find-triangular-sum-of-an-array) | Medium | `Array` `Combinatorics` `Math` `Simulation` |
| 2224 | [Minimum Number of Operations to Convert Time](https://leetcode.com/problems/minimum-number-of-operations-to-convert-time) | Easy | `Greedy` `String` |
...
| 2259 | [Remove Digit From Number to Maximize Result](https://leetcode.com/problems/remove-digit-from-number-to-maximize-result) | Easy | `Enumeration` `Greedy` `String` |
| 2264 | [Largest 3-Same-Digit Number in String](https://leetcode.com/problems/largest-3-same-digit-number-in-string) | Easy | `String` |
| 2265 | [Count Nodes Equal to Average of Subtree](https://leetcode.com/problems/count-nodes-equal-to-average-of-subtree) | Medium | `Binary Tree` `Depth-First Search` `Tree` |
...
| 2347 | [Best Poker Hand](https://leetcode.com/problems/best-poker-hand) | Easy | `Array` `Counting` `Hash Table` |
...
| 2383 | [Minimum Hours of Training to Win a Competition](https://leetcode.com/problems/minimum-hours-of-training-to-win-a-competition) | Easy | `Array` `Greedy` |
...
| 2423 | [Remove Letter To Equalize Frequency](https://leetcode.com/problems/remove-letter-to-equalize-frequency) | Easy | `Counting` `Hash Table` `String` |
...
| 2481 | [Minimum Cuts to Divide a Circle](https://leetcode.com/problems/minimum-cuts-to-divide-a-circle) | Easy | `Geometry` `Math` |
...
| 2506 | [Count Pairs Of Similar Strings](https://leetcode.com/problems/count-pairs-of-similar-strings) | Easy | `Array` `Bit Manipulation` `Counting` `Hash Table` `String` |
| 2511 | [Maximum Enemy Forts That Can Be Captured](https://leetcode.com/problems/maximum-enemy-forts-that-can-be-captured) | Easy | `Array` `Two Pointers` |
| 2515 | [Shortest Distance to Target String in a Circular Array](https://leetcode.com/problems/shortest-distance-to-target-string-in-a-circular-array) | Easy | `Array` `String` |
| 2520 | [Count the Digits That Divide a Number](https://leetcode.com/problems/count-the-digits-that-divide-a-number) | Easy | `Math` |
| 2525 | [Categorize Box According to Criteria](https://leetcode.com/problems/categorize-box-according-to-criteria) | Easy | `Math` |
...
| 2591 | [Distribute Money to Maximum Children](https://leetcode.com/problems/distribute-money-to-maximum-children) | Easy | `Greedy` `Math` |
...
| 2600 | [K Items With the Maximum Sum](https://leetcode.com/problems/k-items-with-the-maximum-sum) | Easy | `Greedy` `Math` |
...
| 2609 | [Find the Longest Balanced Substring of a Binary String](https://leetcode.com/problems/find-the-longest-balanced-substring-of-a-binary-string) | Easy | `String` |
...
| 2660 | [Determine the Winner of a Bowling Game](https://leetcode.com/problems/determine-the-winner-of-a-bowling-game) | Easy | `Array` `Simulation` |
| 2661 | [First Completely Painted Row or Column](https://leetcode.com/problems/first-completely-painted-row-or-column) | Medium | `Array` `Hash Table` `Matrix` |
...
| 2682 | [Find the Losers of the Circular Game](https://leetcode.com/problems/find-the-losers-of-the-circular-game) | Easy | `Array` `Hash Table` `Simulation` |
| 2683 | [Neighboring Bitwise XOR](https://leetcode.com/problems/neighboring-bitwise-xor) | Medium | `Array` `Bit Manipulation` |
...
| 2765 | [Longest Alternating Subarray](https://leetcode.com/problems/longest-alternating-subarray) | Easy | `Array` `Enumeration` |
...
| 2839 | [Check if Strings Can be Made Equal With Operations I](https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-i) | Easy | `String` |
...
| 2923 | [Find Champion I](https://leetcode.com/problems/find-champion-i) | Easy | `Array` `Matrix` |
...
| 2970 | [Count the Number of Incremovable Subarrays I](https://leetcode.com/problems/count-the-number-of-incremovable-subarrays-i) | Easy | `Array` `Binary Search` `Enumeration` `Two Pointers` |
...
| 2980 | [Check if Bitwise OR Has Trailing Zeros](https://leetcode.com/problems/check-if-bitwise-or-has-trailing-zeros) | Easy | `Array` `Bit Manipulation` |
...
| 3000 | [Maximum Area of Longest Diagonal Rectangle](https://leetcode.com/problems/maximum-area-of-longest-diagonal-rectangle) | Easy | `Array` |
...
| 3038 | [Maximum Number of Operations With the Same Score I](https://leetcode.com/problems/maximum-number-of-operations-with-the-same-score-i) | Easy | `Array` `Simulation` |
...
| 3114 | [Latest Time You Can Obtain After Replacing Characters](https://leetcode.com/problems/latest-time-you-can-obtain-after-replacing-characters) | Easy | `Enumeration` `String` |
...
| 3127 | [Make a Square with the Same Color](https://leetcode.com/problems/make-a-square-with-the-same-color) | Easy | `Array` `Enumeration` `Matrix` |
...
| 3405 | [Count the Number of Arrays with K Matching Adjacent Elements](https://leetcode.com/problems/count-the-number-of-arrays-with-k-matching-adjacent-elements) | Hard | `Combinatorics` `Math` |
...
| 3436 | [Find Valid Emails](https://leetcode.com/problems/find-valid-emails) | Easy | `Database` |
...
| 3642 | [Find Books with Polarized Opinions](https://leetcode.com/problems/find-books-with-polarized-opinions) | Medium |  |
...
| 3674 | [Minimum Operations to Equalize Array](https://leetcode.com/problems/minimum-operations-to-equalize-array) | Easy | `Array` `Bit Manipulation` `Brainteaser` |
